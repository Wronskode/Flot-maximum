...
\begin{algorithm}[H]
	...
	\begin{algorithmic}[1]
		...
		\While{il existe des sommets actifs (dont l'excédent est strictement positif)}
			\State Appliquer Poussage ou Réétiquetage
		\EndWhile
...
\tabto{1cm} $\rightarrow$ On réétiquette $A$ : hauteur$[A] = 1$
\tabto{1cm} $\rightarrow$ On regarde les successeurs de $A$ :
\tabto{2.5cm} On réétiquette $B$ et $C$ : hauteur$[B] = 1$ et hauteur$[C] = 1$
\tabto{2.5cm} On ne pousse pas le préflot : hauteur$[A] = $ hauteur$[B] = $ hauteur$[C]$
\tabto{1cm} $\rightarrow$ On réétiquette $A$ : hauteur$[A] = 1+ \min\{1;1\} = 2$
\tabto{1cm} $\rightarrow$ L'excédent de $A$ est strictement positif : sommets$\_$actifs $= [C,A]$
\\\\
...
\tabto{1cm} $\rightarrow$ On réétiquette $C$ : hauteur$[C] = 1 + 0 = 1$
\tabto{1cm} $\rightarrow$ On regarde les successeurs de $C$ :
\tabto{2.5cm} On réétiquette $D$ : hauteur$[D] = 1 + \min\{2;0\} = 1$
\tabto{2.5cm} On ne pousse pas le préflot : hauteur$[C] = $ hauteur$[D]$
\tabto{1cm} $\rightarrow$ On réétiquette $C$ : hauteur$[C] = 1 + 1 = 2$
\tabto{1cm} $\rightarrow$ L'excédent de $C$ est strictement positif : sommets$\_$actifs $= [A,C]$
\\\\
Faisons un point sur les dictionnaires :
...
\end{center}
On traite le sommet $A$ :\\
\tabto{1cm} $\rightarrow$ On réétiquette $A$ : hauteur$[A] = 1 + \min\{1;2\} = 2$
\tabto{1cm} $\rightarrow$ On regarde les successeurs de $A$ :
\tabto{2.5cm} On réétiquette $B$ et $C$ : hauteur$[B] = 1 + \min\{1;0\} = 1$ et hauteur$[C] = 1 + 1 = 2$
\tabto{2.5cm} On pousse le préflot : hauteur$[A] = $ hauteur$[B] + 1= $ hauteur$[C]$ et $r(A,B)>0$, $r(A,C)=0$\\
\tabto{4cm} excédent$[A] = 4 - 3 = 1$, excédent$[B] = 0 + 3 = 3$, flot$[A,B] = 0 + 3 = 3$, flot$[B,A] = 0 - 3 = -3$, sommets$\_$actifs $= [C,B]$
\tabto{1cm} $\rightarrow$ On réétiquette $A$ : hauteur$[A] = 1+ \min\{1;2\} = 2$
\tabto{1cm} $\rightarrow$ L'excédent de $A$ est strictement positif : sommets$\_$actifs $= [C,B,A]$
\\\\
Faisons un point sur les dictionnaires :
...
\tabto{1cm} $\rightarrow$ On réétiquette $C$ : hauteur$[C] = 1+1=2$
\tabto{1cm} $\rightarrow$ On regarde les successeurs de $C$ :
\tabto{2.5cm} On réétiquette $D$ : hauteur$[D] = 1+0 = 1$
\tabto{2.5cm} On pousse le préflot : hauteur$[C] = $ hauteur$[D] + 1$ et $r(C,D)>0)$\\
\tabto{4cm} excédent$[C] = 3 - 2 = 1$, excédent$[B] = 0 + 2 = 2$, flot$[A,B] = 0 + 2 = 2$, flot$[B,A] = 0 - 2 = -2$, sommets$\_$actifs $= [B,A,D]$
\tabto{1cm} $\rightarrow$ On réétiquette $C$ : hauteur$[C] = 1+1=2$
\tabto{1cm} $\rightarrow$ L'excédent de $C$ est strictement positif : sommets$\_$actifs $= [B,A,D,C]$
\\\\
Faisons un point sur les dictionnaires :
\tabto{2.5cm} $\rightarrow$ hauteur $= \{S : 6, A:2,B:1,C:2,D:1,P:0\}$
...
\tabto{1cm} $\rightarrow$ On réétiquette $B$ : hauteur$[B] = 1 + \min\{1,0\} = 1$
\tabto{1cm} $\rightarrow$ On regarde les successeurs de $B$ :
\tabto{2.5cm} On réétiquette $D$ et $P$ : hauteur$[D] = 1 + \min\{2,0\} = 1$ et hauteur$[P] = 0$
\tabto{2.5cm} On pousse le préflot sur $[B,P]$: hauteur$[B] = $ hauteur$[D] = $ hauteur$[P] +1$ et $r(B,D)=0$, $r(B,P)>0$\\
\tabto{4cm} excédent$[B] = 3 - 2 = 1$, excédent$[P] = 0 + 2 = 2$, flot$[B,P] = 0 + 2 = 2$, flot$[P,B] = 0 -2 = -2$, sommets$\_$actifs $= [C]$
\tabto{1cm} $\rightarrow$ On réétiquette $B$ : hauteur$[B] = 1 + 1 = 2$
\tabto{1cm} $\rightarrow$ L'excédent de $B$ est strictement positif : sommets$\_$actifs $= [A,D,C,B]$
\\\\
Faisons un point sur les dictionnaires :
...
\end{center}
On traite le sommet $A$ :\\
\tabto{1cm} $\rightarrow$ On réétiquette $A$ : hauteur$[A] = 1 + 2 = 3$
\tabto{1cm} $\rightarrow$ On regarde les successeurs de $A$ :
\tabto{2.5cm} On réétiquette $C$ : hauteur$[C] = 1$
\tabto{2.5cm} On ne pousse pas le préflot : hauteur$[A] = $ hauteur$[C] + 2$ 
\tabto{1cm} $\rightarrow$ On réétiquette $A$ : hauteur$[A] = 1 + 1 =2$
\tabto{1cm} $\rightarrow$ L'excédent de $A$ est strictement positif : sommets$\_$actifs $= [D,C,B,A]$
\\\\
Faisons un point sur les dictionnaires :
...
\tabto{1cm} $\rightarrow$ On réétiquette $D$ : hauteur$[D] = 1 + \min\{2;0\} = 1 $
\tabto{1cm} $\rightarrow$ On regarde les successeurs de $D$ :
\tabto{2.5cm} On réétiquette $A$ et $P$ : hauteur$[A] = 1 + 1 = 2$ et hauteur$[P] = 0$
\tabto{2.5cm} On pousse le préflot sur $[D,P]$: hauteur$[D] = $ hauteur$[A] -1 = $ hauteur$[P] + 1$ et $r(D,A)>0$, $r(D,P) > 0$\\
\tabto{4cm} excédent$[D] = 2 - 2 = 0$, excédent$[P] = 2 + 2 = 4$, flot$[D,P] = 0 + 2 = 2$, flot$[P,B] = 0 -2 = -2$, sommets$\_$actifs $= [C,B,A]$
\tabto{1cm} $\rightarrow$ On réétiquette $D$ : hauteur$[D] = 1 + \min\{2;0\} = 1$
\tabto{1cm} $\rightarrow$ L'excédent de $D$ est nul : sommets$\_$actifs $= [C,B,A]$
\\\\
Faisons un point sur les dictionnaires :
\tabto{2.5cm} $\rightarrow$ hauteur $= \{S : 6, A:2,B:2,C:1,D:1,P:0\}$
...
\end{center}
On traite le sommet $C$ :\\
\tabto{1cm} $\rightarrow$ On réétiquette $C$ : hauteur$[C] = 1$
\tabto{1cm} $\rightarrow$ On regarde les successeurs de $C$ : il n'y en a plus
\tabto{1cm} $\rightarrow$ On réétiquette $C$ : hauteur$[C] = 1$
\tabto{1cm} $\rightarrow$ Aucune modification dans hauteur ou excédent n'a été réalisé : sommets$\_$actifs $= [B,A]$
\\\\
Faisons un point sur les dictionnaires :
\tabto{2.5cm} $\rightarrow$ hauteur $= \{S : 6, A:2,B:2,C:1,D:1,P:0\}$
\tabto{2.5cm} $\rightarrow$ excédent $= \{S : 0, A:1,B:1,C:1,D:0,P:4\}$
...
\tabto{1cm} $\rightarrow$ On regarde les successeurs de $B$ :
\tabto{2.5cm} On réétiquette $D$ : hauteur$[D] = 1 + \min\{2,0\} = 1$
\tabto{2.5cm} On pousse le préflot sur $[B,D]$: hauteur$[B] = $ hauteur$[D] + 1$ et $r(B,D)=0$\\
\tabto{4cm} excédent$[B] = 1 -1 = 0$, excédent$[D] = 0 + 1 = 1$, flot$[B,D] = 0 + 1 = 1$, flot$[D,B] = 0 -1 = -1$, sommets$\_$actifs $= [A,D]$
\tabto{1cm} $\rightarrow$ On réétiquette $B$ : hauteur$[B] = 1 + 1 = 2$
\tabto{1cm} $\rightarrow$ L'excédent de $B$ est nul : sommets$\_$actifs $= [A,D]$
\\\\
Faisons un point sur les dictionnaires :
\tabto{2.5cm} $\rightarrow$ hauteur $= \{S : 6, A:2,B:2,C:1,D:1,P:0\}$
...
\tabto{2.5cm} On ne pousse pas le préflot : hauteur$[A] = $ hauteur$[C] + 2$ 
\tabto{1cm} $\rightarrow$ On réétiquette $A$ : hauteur$[A] = 1 + 1 =2$
\tabto{1cm} $\rightarrow$ Aucune modification dans hauteur ou excédent n'a été réalisé : sommets$\_$actifs $= [D]$
\\\\
Faisons un point sur les dictionnaires :
\tabto{2.5cm} $\rightarrow$ hauteur $= \{S : 6, A:2,B:2,C:1,D:1,P:0\}$
\tabto{2.5cm} $\rightarrow$ excédent $= \{S : 0, A:1,B:0,C:1,D:1,P:4\}$
...
\tabto{2.5cm} On réétiquette $A$ et $P$ : hauteur$[A] = 1 + 1 = 2$ et hauteur$[P] = 0$
\tabto{2.5cm} On pousse le préflot sur $[D,P]$: hauteur$[D] = $ hauteur$[A] -1 = $ hauteur$[P] + 1$ et $r(D,A)>0$, $r(D,P) > 0$\\
\tabto{4cm} excédent$[D] = 1 - 1 = 0$, excédent$[P] = 4 + 1 = 5$, flot$[D,P] = 2 + 1 = 3$, flot$[P,B] = -2 - 1 = -3$, sommets$\_$actifs $= []$
\tabto{1cm} $\rightarrow$ On réétiquette $D$ : hauteur$[D] = 1 + \min\{2;0\} = 1$
\tabto{1cm} $\rightarrow$ L'excédent de $D$ est nul : sommets$\_$actifs $= [$ $]$
\\\\
Faisons un point sur les dictionnaires :
\tabto{2.5cm} $\rightarrow$ hauteur $= \{S : 6, A:2,B:2,C:1,D:1,P:0\}$
\tabto{2.5cm} $\rightarrow$ excédent $= \{S : 0, A:1,B:0,C:1,D:1,P:4\}$
