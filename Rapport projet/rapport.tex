...
\subsection{L'algorithme de Ford-Fulkerson\cite{Ford_Fulkerson_1956}}
...
\subsection{L'algorithme d'Edmonds-Karp\cite{10.1145/321694.321699}}
...
\subsection{L'algorithme de Dinic\cite{article}}
...
\subsection{Algorithme BLNPSSSW (2020)\cite{chen2022maximumflowminimumcostflow}}
...
\end{itemize}
Ici \[\tilde{\mathcal{O}}\] indique une complexité asymptotique qui ignore certains facteurs logarithmiques.
...
\subsection{Algorithme de Gao-Liu-Peng (2021)\cite{barick2024effectspacetimegeometryneutrino}}
...
\subsection{Algorithme de Chen, Kyng, Liu, Peng, Gutenberg, Sachdeva (2022)\cite{chen2022maximumflowminimumcostflow}}
